...
const serviceLinks = [
  { label: 'Website and Software Development', to: '/#services' },
  { label: 'Mobile Application Devleopment', to: '/#services' },
  { label: 'CRM & ERP Solutions', to: '/#services' },
  { label: 'Digital Marketing Services', to: '/#services' },
  { label: 'BPO & Customer Support Solutions', to: '/#services' },
  { label: 'AI & Automation Services', to: '/#services' },
]
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-sm text-slate-400">
              <li className="flex items-start gap-3">
                ...
                <span className="pt-2">+91 9146802212</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-amber-600/30 text-amber-400">
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <span className="pt-2">office@growbigllp.com</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-amber-600/30 text-amber-400">
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <div className="space-y-1 pt-2">
                  <span className="block">24 Hours Open</span>
                  <span className="block">Shift-based Operations</span>
                </div>
              </li>
            </ul>
          </div>
