...
This API returns Site Profile, Site Page, route, basic Site Menu, basic component, and basic form data.

Reusable content and advanced multilingual fallback come later.
